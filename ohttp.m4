...
==>
  ...
  ((Ex #i. KU(gx)@i & #i < #j) &
   (Ex #i. KU(op)@i & #i < #j)) |
  (Ex k n p2 #i . ReuseNonce(k, n, op, p2)@i & #i < #j)"
...
lemma aead_sources[]:
  "All k n a p #j. KU(seal(k,n,a,p))@j
==>
  (Ex #i. KU(p)@i & #i < #j) |
...
lemma tdone:
  exists-trace
  "Ex tid #i. T_Done(tid)@i"

lemma phq:
  exists-trace
  "Ex gx opaque #i. PHQ(gx, opaque)@i"
...
/* aead(psk, nonce2, <'0x02', key_id2>, answer) */
